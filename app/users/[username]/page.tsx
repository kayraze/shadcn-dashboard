          ...
          <div className="bg-primary-foreground p-4 rounded-lg">
            ...
            <div className="space-y-4 mt-4">
              ...
              <div className="flex gap-2">
                ...
                <span className="">john.doe@gamil.com</span>
              </div>
              <div className="flex gap-2">
          ...
          <div className="bg-primary-foreground p-4 rounded-lg space-y-2">
            <div className="flex items-center gap-2">
              <Avatar className="size-12">
                ...
                <AvatarFallback>Joen Doe</AvatarFallback>
              </Avatar>
              <h1 className="text-xl font-semibold">John Doe</h1>
            </div>
            <p className="text-sm text-muted-foreground">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores cumque totam illo autem iusto ducimus sequi? Officia ex quod soluta delectus aut omnis nobis excepturi accusamus, ab, eum, dolore quos?</p>
          </div>
          {/* CHART CONTAINER  */}
          <div className="bg-primary-foreground p-4 rounded-lg">
